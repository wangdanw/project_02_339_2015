...
$(document).ready( function() {
	...
	*/
	$("a.dd-toggle").click( function(e) { 
		...
		*/
		if ( $(this).next(".backup").hasClass("dd-shown") ) {
			...
			/*
				...
				.dd-shown, and adding the class of .dd-hidden
			*/
			$(this).next(".backup").removeClass("dd-shown").addClass("dd-hidden");
		} 
		// Else means that this is the case if our drop-down is not shown
		else {

			// As a result, we do the reverse of what is listed above.
			$(this).next(".backup").removeClass("dd-hidden").addClass("dd-shown");
		}
	});
...
$(document).ready( function() {
	...
	*/
	$("a.dd-toggle").click( function(e) { 
		...
		*/
		if ( $(this).next(".backupl").hasClass("dd-shown") ) {
			...
			/*
				...
				.dd-shown, and adding the class of .dd-hidden
			*/
			$(this).next(".backupl").removeClass("dd-shown").addClass("dd-hidden");
		} 
		// Else means that this is the case if our drop-down is not shown
		else {

			// As a result, we do the reverse of what is listed above.
			$(this).next(".backupl").removeClass("dd-hidden").addClass("dd-shown");
		}
	});
...
$(document).ready( function() {
	...
	*/
	$("a.dd-toggle").click( function(e) { 
		...
		*/
		if ( $(this).next(".filter1").hasClass("dd-shown") ) {
			...
			/*
				...
				.dd-shown, and adding the class of .dd-hidden
			*/
			$(this).next(".filter1").removeClass("dd-shown").addClass("dd-hidden");
		} 
		// Else means that this is the case if our drop-down is not shown
		else {

			// As a result, we do the reverse of what is listed above.
			$(this).next(".filter1").removeClass("dd-hidden").addClass("dd-shown");
		}
	});
